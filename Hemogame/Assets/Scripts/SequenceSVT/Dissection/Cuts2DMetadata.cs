...
class Cuts2DMetadata
{
    ...
    public Cuts2DMetadata(Plane plane, Mesh mesh, bool shareVertices, bool smoothVertices)
    {
    ...
    private float GetDistanceRelativeToPlane(Vector3 vertex1, Vector3 vertex2, out Vector3 pointOfintersection)
    {
        ...
        return distance / (vertex2 - vertex1).magnitude;
    }
